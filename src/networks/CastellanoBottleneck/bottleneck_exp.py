...
class FCNCastellanoBNSmall2(nn.Module):
    def __init__(self, in_channels=3, out_channels=64):
        super().__init__()
        ...
        features = [
            ...
            nn.Conv2d(in_channels=out_channels, out_channels=out_channels, kernel_size=(3, 3), stride=1),
            nn.PReLU(),
            nn.Conv2d(in_channels=out_channels, out_channels=out_channels * 2, kernel_size=(1, 1), stride=1),
            nn.PReLU(),
...
class FCNCastellanoBNSmall3(nn.Module):
    def __init__(self, in_channels=3, out_channels=64):
        super().__init__()
        ...
        features = [
            ...
            # Bottleneck
            nn.Conv2d(in_channels=out_channels // 2, out_channels=out_channels // 2, kernel_size=(1, 1), stride=1),
            nn.PReLU(),
            nn.Conv2d(in_channels=out_channels // 2, out_channels=out_channels, kernel_size=(3, 3), stride=1),
            nn.PReLU(),
            nn.Conv2d(in_channels=out_channels, out_channels=out_channels, kernel_size=(1, 1), stride=1),
...
class FCNCastellanoBNSmall4(nn.Module):
    def __init__(self, in_channels=3, out_channels=32):
        ...
        features = [
            ...
            nn.Conv2d(in_channels=out_channels * 2, out_channels=out_channels * 2, kernel_size=(3, 3), stride=1),
            nn.Conv2d(in_channels=out_channels * 2, out_channels=out_channels * 4, kernel_size=(3, 3), stride=1),
        ...
        head = [
            nn.Linear(in_features=out_channels * 4, out_features=1),
        ]
...
class FCNCastellanoBNSmall5(nn.Module):
    def __init__(self, in_channels=3, out_channels=32):
        super().__init__()
